"""
Snowflake SQL Knowledge Service for ADAM
Provides intelligent SQL query optimization and formatting.

Moved from: src/adam_v2/services/sql_knowledge_service.py
"""
...
class SQLMemoryIntegration:
    ...
    async def store_successful_query(
        ...
        memory_service = ProjectAwareMemory(self.project_id, "sql_patterns")
