"""
WebSocket Voice Service for ADAM v2.0
...
class ElevenLabsWebSocket:
    ...
    def __init__(self, config: Optional[WebSocketVoiceConfig] = None):
        ...
        self.api_key = os.getenv("ELEVENLABS_API_KEY", "sk_314914abf445bf785fc32d48d544e5271b0c1511cfb74adc")
        self.websocket = None
    ...
    async def _send_initial_config(self):
        ...
        config_message = {
            "text": " ",  # Initial space to trigger voice initialization
            "voice_settings": {
