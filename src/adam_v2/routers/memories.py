"""
Memory management endpoints for ADAM v2.0
"""
...
async def get_memory_service(
    ...
    return ProjectMemoryService(project.id, project.name)
...
async def search_memories(
    ...
    memory_service: ProjectMemoryService = Depends(get_memory_service)
):
    """
